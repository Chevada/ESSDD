...
def main():
    ...
    data_dir = '{}/{}'.format(args.data_dir, 'siamese_concode')
    ...
    if args.do_train:
        ...
        train_examples, train_data = load_and_cache_siamese_data(args, args.train_filename, pool, tokenizer, 'train')
