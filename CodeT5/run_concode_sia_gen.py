...
此文件用于训练导入孪生网络参数后，codet5在concode数据集上的训练效果。
...
def eval_result(args, eval_data, eval_examples, model, tokenizer, split_tag, criteria):
    args.res_dir = 'saved_models/concode/codet5_base_all_lr10_bs24_src320_trg150_pat3_e30_20241213_082112/prediction'
    output_fn = os.path.join(args.res_dir, "test_{}.output".format(criteria))
    gold_fn = os.path.join(args.res_dir, "test_{}.gold".format(criteria))
    src_fn = os.path.join(args.res_dir, "test_{}.src".format(criteria))
    # 初始化 dev_accs 列表
...
def main():
    ...
    encoder_params_path = 'saved_models/siamese/codet5_base_all_useeuc_lr10_bs40_src250_trg32_pat0_e30_20241217_1319'
    ...
    if args.do_test:
        # args.output_dir = '/AIsoftwaremfq2023/code/cl_code/CodeT5/sh/saved_models/concode/codet5_base_all_lr10_bs24_src320_trg150_pat3_e30_20241213_082112'
        logger.info("  " + "***** Testing *****")
        logger.info("  Batch size = %d", args.eval_batch_size)
